  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        "banner-mobile-0": "url('/images/banner-mobile-0.png')",
        "banner-mobile-1": "url('/images/banner-mobile-1.png')",
        "banner-mobile-2": "url('/images/banner-mobile-2.png')",
        "banner-mobile-3": "url('/images/banner-mobile-3.png')",
        "banner-mobile-4": "url('/images/banner-mobile-4.png')",
        "banner-mobile-5": "url('/images/banner-mobile-5.png')",
        "banner-mobile-6": "url('/images/banner-mobile-6.png')",
