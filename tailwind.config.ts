  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        "adult-leito": "url('/images/adult-leito2.jpeg')",
        "adult-fralda": "url('/images/adult-fralda2.jpeg')",
        "adult-calça": "url('/images/adult-calça2.jpeg')",
        "lady-absorvente": "url('/images/lady-absorvente.jpeg')",
        "lady-fralda": "url('/images/lady-fralda.jpeg')",
        "lady-protetor": "url('/images/lady-protetor.jpeg')",
        "baby-fralda": "url('/images/baby-fralda.jpeg')",
        "baby-calça": "url('/images/baby-calça.jpeg')",
        "baby-lenço": "url('/images/baby-lenço.jpeg')",
        "limp-pasta": "url('/images/limp-pasta.jpeg')",
        "pet-fralda": "url('/images/pet-fralda.jpeg')",
        "pet-tapete": "url('/images/pet-tapete.jpeg')",
        "pet-lenço": "url('/images/pet-lenço.jpeg')",
        "pet-fralda-female": "url('/images/pet-fralda-female.jpeg')",
        "eco-lenço": "url('/images/eco-lenço.jpeg')",
        "eco-toalha": "url('/images/eco-toalha.jpeg')",
        "eco-fralda": "url('/images/eco-fralda.jpeg')",
        "eco-papel": "url('/images/eco-papel.jpeg')",
        "eco-roupa": "url('/images/eco-roupa.jpeg')",
