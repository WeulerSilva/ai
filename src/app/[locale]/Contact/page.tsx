...
export default function Pages() {
    ...
    return (
        <section className='w-screen h-full flex justify-center items-center flex-col mt-6 md:mt-16 lg:mt-24 xl:mt-24'>
            <div className="w-[90%] h-[300px] md:bg-contact-first bg-cover bg-no-repeat md:h-[400px] md:bg-[-350px] lg:bg-[-150px] 2xl:bg-right">
                ...
                <p className="w-full text-justify font-medium md:w-[40%]">Bem-vindo ao nosso serviço de Customer Care!
