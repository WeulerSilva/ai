...
export const FirstHomeCarrosel = () => {
    ...
    return (
        <section>
            <div className='w-screen h-[380px] flex justify-center mt-12 md:mb-4 md:mt-20 xl:mt-20 md:h-[200px] lg:h-[300px] xl:h-[400px] 2xl:h-[500px]'>
                <div className={`w-full h-full flex justify-end flex-col items-center mb-4 bg-contain bg-center bg-no-repeat relative
                        ${changeBanner === 0 ? 'bg-banner-mobile-0 md:bg-banner-0' : 
                            changeBanner === 1 ? 'bg-banner-mobile-0 md:bg-banner-0' : 'bg-banner-mobile-0 md:bg-banner-0'} cursor-pointer bg-cover md:w-[90%] 
